...
export function ProblemDetail({ 
  ...
  // Функция для инициализации AdSense после рендера
  useEffect(() => {
    if (isClient) {
      try {
        // @ts-ignore - AdSense глобальный объект
  ...
  return (
    <>
      {/* AdSense Script */}
      <Script
        src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3369297587971128"
        ...
        <Card className="border-2 border-dashed border-blue-300 bg-blue-50">
          <CardContent className="pt-6 pb-6">
            <div className="text-center space-y-4">
              <h3 className="text-lg font-semibold text-blue-800">Advertisement</h3>
              <div className="w-full overflow-hidden rounded-lg">
                ...
                <ins
                  ...
                  data-ad-client="ca-pub-3369297587971128"
                  data-ad-slot="5962737687"
              ...
              <p className="text-xs text-blue-600">
                Advertisement helps us keep StartOrigin free for everyone
              </p>
            </div>
          </CardContent>
        </Card>
